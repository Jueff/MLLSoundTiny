 ...
 *
 * @brief LedToSound class for processing LED data and controlling sound modules.
 * 
 * This class processes incoming LED data, maps it to sound commands, and manages a queue
 * to send these commands to multiple sound modules. It supports setting active modules,
 * playing tracks, and handling repeat modes.
 * 
 * Diese Klasse verarbeitet eingehende LED-Daten, mappt sie auf Sound-Befehle und verwaltet
 * eine Warteschlange, um diese Befehle an mehrere Sound-Module zu senden. Sie unterstützt
 * das Setzen aktiver Module, das Abspielen von Tracks und die Handhabung von Wiederholungsmodi.
*/
